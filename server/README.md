...
- O usuário não pode atualizar o seu email para um email já utilizado;
...
- Os agendamentos devem estar disponíveis entre 8h às 17h (Primeiro às 8h, Último às 17h);
